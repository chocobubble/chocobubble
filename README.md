...
> - **개인 업무에 그치지 않고 동료의 업무를 적극적으로 도우며, 팀에 일이 주어지면 먼저 나서서 수행합니다.**
> - **팀원 부재 시 대신 업무를 처리할 수 있을 정도로 동료들의 업무에 관심을 갖고 학습합니다.**
> - **그 덕에 팀내 업무 전반을 이해하게 되어 현재 임시로 클라이언트 파트 리더를 맡아 팀 내 업무 분배 및 일정 관리를 담당하고 있습니다.**
> - **공무원에서 개발자로 이직하기 위해 1년 반간 하루 6-7시간씩 독학한 끈기와 학습 의지를 보유했습니다.**
> - **현재도 퇴근 후 꾸준한 학습을 통해 새로운 기술에 대한 도전을 멈추지 않습니다.**
...
### 퍼즐원 스튜디오 - 플랫폼 클라이언트 프로그래머 (파트 리더)
**2024.01 ~ 현재**

**1. AI 관련 툴 개발 및 기술 공유**
- **Unity MCP** 제작하여 gemini-cli 와 연계한 unity 엔진 작업 능률 향상 툴 개발
- **LLM AI API**를 활용상 GitLab 웹훅 연동 코드 리뷰 자동화 (40% 시간 단축)
- 사내 프로그래머 대상 AI 툴(Cody) 기술 공유 세미나 진행

**2. 게임 레벨 테스트 툴 개발**
- **딥링크**를 활용한 특정 버전 레벨 직접 진입 시스템 구축
- **macOS 빌드 환경 신규 구축**으로 플랫폼 지원 범위 확장
- **Unity 기반 공통 딥링크 파라미터 파싱 모듈** 개발 (C#)
- 기존 10분 이상 소요되던 레벨 비교 작업을 **수 초로 단축**

**3. 대규모 코드베이스 리팩토링 & 검증 시스템**
- **.NET Roslyn Compiler**를 활용한 C# 코드 분석 & 수정 툴 개발
- **Syntax Tree API** 기반 패턴 매칭 알고리즘 구현
- **100여 개 패키지**에 코딩 컨벤션 일괄 적용
- **게임 출시 전 코드 검증 프로세스** 확립으로 안정성 확보

**4. 광고 SDK 통합 관리**
- **AdMob, AppLovin, IronSource** 다중 플랫폼 통합 연동
- **광고 메디에이션** 및 실시간 전환 기능으로 수익 증가
- **모니터링 시스템** 구축으로 실시간 광고 이슈 대응

<br>

### 공무원 (행정직)
**재직기간**: 2021.01 ~ 2024.01
- 인사, 총무, 회계 등 서무 업무를 통한 **협업 및 커뮤니케이션 능력** 
- 부서원 등 다양한 이해관계자와의 업무 조율 경험
